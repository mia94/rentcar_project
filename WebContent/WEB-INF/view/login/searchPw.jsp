...
<link href="${pageContext.request.contextPath }/css/search.css?aaaaaa" rel="stylesheet"  type="text/css">
...
<div id="container">
	...
	<fieldset>
	 ...
	 <p>
      ...
      <p id="href">
      	<a href="searchId.do" id="btnSearchId">ID찾기</a>
      	<input type="submit" value="PW찾기"  id="btnSearchPw">
